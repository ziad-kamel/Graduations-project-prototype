...
const DashboardPage = () =>{
  ...
  return (
    ...
    <div className="mb-8 space-y-4">
      ...
      text-center">
        Unlock the infinite possibilities of AI
      </h2>
      <p className="test-muted-foreground font-light text-sm md:text-lg text-center">
      Discover the power of AI through a chat with the smartest AI 
      </p>
...
/*
 if i want to change the color of the card change border-black/5 to the color i want
<Card 
          key={tool.href}
